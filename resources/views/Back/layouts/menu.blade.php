...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-2">BLOG SİTESİ ADMİN </div>
        </a>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" @if(Request::segment(2)=="kategoriler") style="color: red !important;" @endif href="{{route('admin.category.index')}}" >

                <i @if(Request::segment(2)=="kategoriler") style="color: red !important;" @endif class="fas fa-fw fa-list"></i>
        ...
        <div class="sidebar-card d-none d-lg-flex">
            ...
            <a class="btn btn-success btn-sm" href="{{asset('front')}}/assets/https://startbootstrap.com/theme/sb-admin-pro">Upgrade to Pro!</a>
        </div>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small">Emir Güney</span>
