    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
                <form method="post" action="{{route('admin.config.update')}}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control"name="active">
                                    <option @if($config->active==1) selected @endif value="1">Acık</option>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn-block btn-md btn-success">Güncelle</button>
